...
void nano_DST_analysis(const int seednumber = 0)
{
  ...
  std::string outputfiletemplate = "analysis_complete_ana509_01312026_backward_efficiency_30_pt_g4_0mrad/analysis_";

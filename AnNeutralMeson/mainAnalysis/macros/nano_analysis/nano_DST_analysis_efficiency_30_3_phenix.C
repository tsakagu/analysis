...
void nano_DST_analysis_efficiency_30_3_phenix(const int seednumber = 0)
{
  ...
  std::string outputfolder = "analysis_complete_ana509_01312026_phenix_efficiency_30_pt_g3_0mrad/";

...
void nano_DST_analysis_efficiency_30_3_high_xf(const int seednumber = 0)
{
  ...
  std::string outputfolder = "analysis_complete_ana509_01312026_high_xf_efficiency_30_pt_g3_0mrad/";
  ...
  AN->set_store_bunch_yields(true, outputbunchtemplate);
  AN->set_trigger_photon(true);
  AN->set_ptcut(3.0, 1000.0);
  AN->set_high_xf_cut(true);

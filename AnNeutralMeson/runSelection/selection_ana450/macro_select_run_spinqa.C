...
void macro_select_run_spinqa(const std::string& runListName = "RunList_hotmap.txt")
{
...
bool hasGoodSpinQA(int runnumber)
{
  // qa_level = 0xffff corresponds to the very first spin QA selection
  unsigned int qa_level = 0xffff; // or equivalently 65535 in decimal notation

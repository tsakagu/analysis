...
class TrackletData
{
  public:
    ...
    int Nsiliconseeds, Nsiliconseeds_vtx; 
...
void SetMinitree(TTree *outTree, TrackletData &tkldata, bool detailed = false)
{
    ...
    outTree->Branch("gl1bco", &tkldata.gl1bco);
    outTree->Branch("bcotr", &tkldata.bcotr);
    ...
    outTree->Branch("Nsiliconseeds", &tkldata.Nsiliconseeds);
    outTree->Branch("Nsiliconseeds_vtx", &tkldata.Nsiliconseeds_vtx);
